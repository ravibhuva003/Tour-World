        ...
        <Row>
          ...
          <Col lg="2">
            <div className="hero__img-box hero__video-box mt-4">
              <video src={heroVideo} alt="" autoPlay loop muted playsInline controls  />
            </div>
          </Col> 
        ...
        <Row>
          <Col lg="6">
            <div className="experience__content">
              ...
              <p>
                We've curated the best travel experiences across the globe. 
                <br/>Join us to explore exotic locations, vibrant cultures, and breathtaking landscapes!
              </p>
            </div>
